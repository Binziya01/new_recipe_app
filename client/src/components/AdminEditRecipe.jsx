...
const AdminEditRecipe = ({onClose, dataRecipe, fetchdata}) => {

    const [data,setData]=useState({
        ...dataRecipe,
        recipeName: dataRecipe?.recipeName,
        category: dataRecipe?.category,
        thumbnailImage: dataRecipe?.thumbnailImage || [],
    ...
    const apiEndpoint = `http://localhost:4000/api/v1/recipe/update-recipe/${data._id}`;
